...
export default class PlayersRenderer {
    ...
    public addNewPlayer(player: Player) {
        ...
        const sprite = new PlayerSprite(player.id, newPlayerContainer, this.spriteSheets, this._terrainContainer, this.staticEffectContainer, player.playerName || "bibite");
